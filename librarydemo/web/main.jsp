    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#book_add").click(function(){
                $("iframe").attr("src","/bookAdmin?method=findBookCases");
            });
            ...
            $("#book_count1").click(function(){
                $("iframe").attr("src","book_count1.jsp");
            });
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item"><a href="/account?method=logout">退出</a></li>
        </ul>
    </div>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a id="book_count1" href="javascript:void(0)">饼图</a></dd>
                        <dd><a id="book_count2" href="javascript:void(0)">柱状图</a></dd>
                        <dd><a id="book_export" href="/bookAdmin?method=exportBook">导出图书数据</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-body">
        ...
        <iframe src="book_manage.jsp" style="width: 100%;height: 100%;border: 0px"></iframe>
